...
class FITSPlotter:
    ...
    def plot(self, save_as=None, title=""):
        ...
        uc1_coords = SkyCoord(ra='18h20m24.81s', dec='-16d11m34.2s', frame='icrs')
        ...
        ax.scatter(x_pix, y_pix, facecolors='none', edgecolors='black', marker='*', s=250, linewidths=1.5, zorder=10)
        
        # Agregar la etiqueta sin fondo y en letra negra
        ax.annotate("UC1", (x_pix + 5, y_pix + 5), color='black', fontsize=12, weight='bold', zorder=11)
